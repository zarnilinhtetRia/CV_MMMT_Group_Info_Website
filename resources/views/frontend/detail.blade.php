...
@section('content')
    ...
    <div class="container-fluid mt-5 px-3">
        <div class="row">
                    ...
                    <div class="card-body p-0" style="background-color: #e7ddd2;">
                        @foreach ($categories as $category)
                            <div class="px-3 py-2 border-bottom">
                                ...
                                @else
                                    <button class="btn w-100 text-left font-weight-bold" type="button"
                                        style="background-color: transparent; border: none;">
                                        * {{ $category->category }}
                                    </button>
                                @endif
            ...
            <div class="col-12 col-md-8 col-lg-9">
                <div class="card shadow p-2 rounded-4 border w-100" style="border-color: #dee2e6;">
                    <div class="card-body">
    ...
    <div class="container-fluid mt-5">
        <div class="row  justify-content-center">
            ...
            <div class="col-12 col-md-8 col-lg-9">
                <div class="card shadow p-4 rounded-4 border" style="border-color: #dee2e6;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between p-2">
                                                ...
                                                <a href="{{ route('blog_post.detail', $post->id) }}"
                                                    class="btn btn-sm morebtn">More</a>
                                            </div>
                                            <hr>
                                        </div>
