                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('servicestore') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf


                                            <div class="form-group">
                                                <label for="type">Service Name<span
                                    ...
                                    <tbody>
                                        @foreach ($service as $key => $service)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $service->name }}</td>
                                                <td><img src="{{ asset('img/' . $service->image) }}" alt=""
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        onclick="if(confirm('Are you sure you want to delete this service?')){ window.location='{{ url('service_delete', $service->id) }}'; } return false;"
